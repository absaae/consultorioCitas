...
def upload_medical_history(username, date, description):
    try:
        # Conexión a la base de datos
        conexion = sqlite3.connect("usuarios.db")
        cursor = conexion.cursor()
        ...
        # Insertar el historial clínico del usuario en la base de datos
        cursor.execute('INSERT INTO historial_clinico (user_id, date, description) VALUES (?, ?, ?)',
        ...
        print("Historial clínico subido exitosamente.")
    except sqlite3.Error as e:
        print("Error al subir historial clínico:", e)
